...
export const ColumnValuesSchema = z.record(z.union([
    TextColumnSchema,
    NumberColumnSchema,
    DateColumnSchema,
    StatusColumnSchema,
...
export function formatColumnValue(columnId, value, columnType) {
...
export function validateAndFormatColumnValues(values, columnTypes) {
