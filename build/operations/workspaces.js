...
// Tool Definitions
export const GET_WORKSPACES_TOOL = {
    name: "get_workspaces",
...
export const GET_WORKSPACE_TOOL = {
    name: "get_workspace",
...
// Operation Functions
export async function getWorkspaces(monday) {
    try {
...
export async function getWorkspace(monday, workspaceId) {
    try {
